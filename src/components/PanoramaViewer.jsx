            ...
            >
                    ...
                    {!viewerReady && (
                        ...
                        >
                            <div className="text-center">
                                ...
                                <p className="fw-semibold small mb-1">Loading 360° View</p>
                ...
                >
                    <button onClick={onClose} className="btn btn-sm pano-control d-flex align-items-center gap-2 px-3 py-2">
                        <ChevronLeft size={16} />
                        <span className="small fw-medium">Exit to Map</span>
                    </button>
                    ...
                    <div className="d-none d-sm-flex align-items-center gap-2 pano-control px-3 py-2">
                        ...
                        <span className="fw-semibold small">{marker.title}</span>
                        <span className="badge badge-accent" style={{ fontSize: 10 }}>360°</span>
                    </div>

                    <div className="d-flex gap-1">
                        <button onClick={() => setShowInfo(!showInfo)} className={`btn btn-sm pano-control px-2 py-2 ${showInfo ? 'text-accent' : ''}`}>
                            <Info size={16} />
                        </button>
                                            ...
                                            {marker.hotspots?.length > 0 && (
                                                <div className="d-flex flex-wrap gap-1">
                                                    {marker.hotspots.map((hs, i) => (
                                                        <span key={i} className="badge bg-dark border border-secondary" style={{ fontSize: 10, fontFamily: 'monospace' }}>
                                                            {hs.text}
                                                        </span>
                                                    ))}
                                                </div>
