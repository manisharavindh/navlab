...
const recentActivity = [
    { action: 'Added 360° view to Main Lobby', time: '2 min ago', icon: Camera, color: '#0dcaf0' },
    { action: 'Updated floor plan for Office Floor', time: '15 min ago', icon: Layers, color: '#7c3aed' },
    { action: 'Published LBX Suite map', time: '1 hour ago', icon: Globe, color: '#198754' },
    { action: 'Added 3 new markers to Tech Park', time: '3 hours ago', icon: MapPin, color: '#ffc107' },
    { action: 'Invited team member', time: '5 hours ago', icon: Users, color: '#6f42c1' },
];

const dashStats = [
    { label: 'Total Maps', value: userMaps.length, icon: Map, color: '#0dcaf0', change: '+2 this week' },
    { label: 'Total Markers', value: userMaps.reduce((a, c) => a + (c.markers?.length || 0), 0), icon: MapPin, color: '#7c3aed', change: '+5 today' },
    { label: '360° Views', value: userMaps.reduce((a, c) => a + (c.markers?.filter(m => m.type === '360').length || 0), 0), icon: Eye, color: '#198754', change: '+3 this week' },
    { label: 'Total Layers', value: userMaps.reduce((a, c) => a + (c.layers?.length || 0), 0), icon: Layers, color: '#ffc107', change: '2 active' },
];
        ...
        <div style={{ background: 'var(--nl-bg)', minHeight: '100vh' }}>
            ...
            <div className="container" style={{ paddingTop: 80 }}>
                ...
                <motion.div
                    ...
                    className="d-flex flex-column flex-sm-row align-items-start align-items-sm-center justify-content-between gap-3 mb-4"
                >
                    <div>
                        <div className="d-flex align-items-center gap-2 mb-1">
                            <span className="dot bg-success" style={{ width: 6, height: 6 }} />
                            <span className="text-muted" style={{ fontSize: 11, fontFamily: 'monospace' }}>Mission Control Online</span>
                        </div>
                    ...
                    <div className="d-flex align-items-center gap-2">
                        ...
                        <Link to={`/lab/${userMaps[0]?.id || 'demo'}`} className="btn btn-accent btn-sm d-flex align-items-center gap-1">
                            ...
                            <div key={i} className="col-6 col-lg-3">
                                ...
                                >
                                    <div className="d-flex align-items-center justify-content-between mb-3">
                                        ...
                                        <span className="text-muted" style={{ fontSize: 10, fontFamily: 'monospace' }}>{s.change}</span>
                                    </div>
                    ...
                    <div className="col-lg-8">
                        <div className="d-flex align-items-center justify-content-between mb-3">
                            <h6 className="fw-semibold mb-0 d-flex align-items-center gap-2">
                                <Map size={15} className="text-accent" /> Your Deployments
                            </h6>
                            <span className="text-muted small" style={{ cursor: 'pointer', fontFamily: 'monospace' }}>View all</span>
                        </div>
                            ...
                            {userMaps.map((mc, i) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        style={{ borderRadius: 12, border: '1px solid var(--nl-border) !important' }}
                                    >
                                        <div className="d-flex align-items-start gap-3 mb-3">
                                            <div
                                                className="d-flex align-items-center justify-content-center rounded flex-shrink-0"
                                                style={{ width: 48, height: 48, background: 'rgba(13,202,240,0.08)' }}
                                            >
                                        ...
                                        <div className="d-flex align-items-center justify-content-between">
                                            ...
                                            <div className="d-flex gap-2">
                                                ...
                                                <Link to={`/lab/${mc.id}`} className="btn btn-sm d-flex align-items-center gap-1 fw-semibold" style={{ fontSize: 11, background: 'rgba(13,202,240,0.12)', color: 'var(--nl-accent)', border: 'none' }}>
                    ...
                    <div className="col-lg-4">
                        ...
                        <div className="mb-4">
                            <h6 className="fw-semibold mb-3 d-flex align-items-center gap-2">
                                <Activity size={15} className="text-purple" /> Recent Activity
                            </h6>

                            <div className="card border-0 p-3" style={{ borderRadius: 12 }}>
                                {recentActivity.map((a, i) => {
                                    const Icon = a.icon;
                                    return (
                                        <div key={i} className="activity-item d-flex align-items-start gap-3">
                                            <div
                                                className="d-flex align-items-center justify-content-center rounded flex-shrink-0 mt-1"
                                                style={{ width: 28, height: 28, background: `${a.color}18` }}
                                            >
                                                <Icon size={13} style={{ color: a.color }} />
                                            </div>
                                            <div>
                                                <div className="small text-muted">{a.action}</div>
                                                <div className="d-flex align-items-center gap-1 text-muted" style={{ fontSize: 10, fontFamily: 'monospace' }}>
                        ...
                        <div>
                            ...
                            <div className="card border-0 p-3" style={{ borderRadius: 12 }}>
                                <Link to={`/lab/${userMaps[0]?.id || 'demo'}`} className="activity-item d-flex align-items-center gap-3 text-decoration-none">
                                    <div className="d-flex align-items-center justify-content-center rounded" style={{ width: 32, height: 32, background: 'rgba(13,202,240,0.12)' }}>
                                ...
                                <div className="activity-item d-flex align-items-center gap-3" style={{ cursor: 'pointer' }}>
                                    <div className="d-flex align-items-center justify-content-center rounded" style={{ width: 32, height: 32, background: 'rgba(124,58,237,0.12)' }}>
                                ...
                                <div className="activity-item d-flex align-items-center gap-3" style={{ cursor: 'pointer' }}>
                                    <div className="d-flex align-items-center justify-content-center rounded" style={{ width: 32, height: 32, background: 'rgba(255,193,7,0.12)' }}>
                                        <Settings size={16} style={{ color: '#ffc107' }} />
                                    </div>
                                    <div className="flex-grow-1">
