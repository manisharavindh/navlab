...
import { Compass, ChevronLeft, MapPin, Eye, Camera, Share2, ExternalLink, X, Menu } from 'lucide-react';
        ...
        return (
            <div className="not-found" style={{ background: 'var(--nl-bg)' }}>
                <div className="text-center px-3">
                    <Compass size={32} className="text-muted mb-3" />
                    <h3 className="fw-bold mb-2">Map Not Found</h3>
                    <p className="text-muted mb-1">
                        No map exists for <code className="text-info">/{slug}</code>
                    </p>
                    <p className="text-muted small mb-4">Check the URL or explore one of our available maps.</p>
                    <Link to="/" className="btn btn-info d-inline-flex align-items-center gap-2">
        ...
        <div className="d-flex flex-column vh-100" style={{ background: 'var(--nl-bg)' }}>
            ...
            >
                ...
                <div className="d-flex align-items-center gap-2">
                    ...
                    <div className="d-none d-sm-flex align-items-center gap-3" style={{ fontSize: 11 }}>
...
function PoiPanel({ m360, mInfo, onMarkerClick, selectedId, compact = false }) {
    return (
        <div className={compact ? '' : 'map-overlay p-3'} style={compact ? {} : { maxHeight: '60vh', overflowY: 'auto' }}>
            ...
            {m360.length > 0 && (
                <div className="mb-3">
                    <div className="d-flex align-items-center gap-1 mb-2 text-info" style={{ fontSize: 10 }}>
